...
from janis_core.ingestion.galaxy.gx.command.components import factory as component_factory
from janis_core.ingestion.galaxy.gx.gxworkflow.parsing.tool_state import load_tool_state
from janis_core.ingestion.galaxy.gx.gxtool.param import (
    Param, 
    InputParam,
    BoolParam,
    OutputParam
...
class InputExtractor:
    ...
    def create_component_for_boolparam(self, gxparam: BoolParam) -> InputComponent:
