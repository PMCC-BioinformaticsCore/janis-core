...
from ...gxtool.tool import Script, Configfile
...
def handle_script(janis: Workflow, i_step: WorkflowStep, script: Script | Configfile) -> None:
...
def get_script_component(i_step: WorkflowStep, script: Script | Configfile) -> InputComponent:
