...
from janis_core.ingestion.galaxy.gx.gxtool.requirements.model import CondaRequirement, Requirement
...
class ToolshedAPIInteractor:
    ...
    def _parse_requirements(self, tool_info: dict[str, Any]) -> list[Requirement]:
        return [CondaRequirement(req['name'], req['version']) for req in tool_info['requirements'] if req['type'] == 'package']
