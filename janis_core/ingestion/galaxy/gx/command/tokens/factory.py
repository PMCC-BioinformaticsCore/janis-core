...
def tokenize(word: str, prioritisation: str='priority', xmltool: Optional[XMLToolDefinition]=None) -> list[Token]:
...
def tokenize_single(word: str, prioritisation: str='priority', xmltool: Optional[XMLToolDefinition]=None) -> Token:
    quoted, word = _handle_quoted(word)
...
def _spawn_kv_tokens(word: str, prioritisation: str='priority', xmltool: Optional[XMLToolDefinition]=None) -> list[Token]:
...
def _spawn_single(word: str, prioritisation: str='priority', xmltool: Optional[XMLToolDefinition]=None) -> Token:
    """
...
def _get_variable_tokens(the_string: str, xmltool: Optional[XMLToolDefinition]=None) -> list[Token]:
