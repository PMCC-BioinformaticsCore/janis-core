...
GALAXY_DATA_DIR = os.path.join(JANIS_INSTALL_DIR, 'ingestion', 'galaxy', 'data')

GALAXY_CONFIG = f'{GALAXY_DATA_DIR}/galaxy_config.yaml'
GALAXY_DATATYPES_YAML = f'{GALAXY_DATA_DIR}/janis_types.yaml'
