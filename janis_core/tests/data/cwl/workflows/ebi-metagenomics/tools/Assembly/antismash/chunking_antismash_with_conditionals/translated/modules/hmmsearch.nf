...
process HMMSEARCH {
    ...
    cpus "${params.after_qc.functional_annotation_and_post_processing.functional_annotation.run_hmmer.hmmsearch.cpus}"
    memory "${params.after_qc.functional_annotation_and_post_processing.functional_annotation.run_hmmer.hmmsearch.memory}"
