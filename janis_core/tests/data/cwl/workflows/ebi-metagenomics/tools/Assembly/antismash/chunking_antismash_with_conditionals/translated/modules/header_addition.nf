...
process HEADER_ADDITION {
    ...
    cpus "${params.after_qc.functional_annotation_and_post_processing.header_addition.cpus}"
    memory "${params.after_qc.functional_annotation_and_post_processing.header_addition.memory}"
