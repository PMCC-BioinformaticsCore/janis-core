...
process EGGNOG_HOMOLOGY_SEARCHES {
    ...
    cpus "${params.after_qc.functional_annotation_and_post_processing.functional_annotation.eggnog.eggnog_homology_searches.cpus}"
    memory "${params.after_qc.functional_annotation_and_post_processing.functional_annotation.eggnog.eggnog_homology_searches.memory}"
