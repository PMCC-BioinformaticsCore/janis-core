...
process CLASSIFICATIONS_TO_OTU_COUNTS {
    ...
    cpus "${params.after_qc.rna_prediction.classify_ssus.classifications_to_otu_counts.cpus}"
    memory "${params.after_qc.rna_prediction.classify_ssus.classifications_to_otu_counts.memory}"
