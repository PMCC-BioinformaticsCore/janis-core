...
process COMPRESSION_FUNC_ANN {
    ...
    cpus "${params.after_qc.functional_annotation_and_post_processing.folder_functional_annotation.compression_func_ann.cpus}"
    memory "${params.after_qc.functional_annotation_and_post_processing.folder_functional_annotation.compression_func_ann.memory}"
