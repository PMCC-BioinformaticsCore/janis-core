...
include { HASHSUM } from '../modules/hashsum'
...
workflow BEFORE_QC {
    ...
    LENGTH_FILTER(
        CLEAN_HEADERS.out.sequences_with_cleaned_headers,
        ch_contig_min_length,
    ...
    hashsum_input = HASHSUM.out.hashsum
    qc_statistics_folder = QC_STATS.out.output_dir
    qc_status = QC_FLAG.out.qc_flag
