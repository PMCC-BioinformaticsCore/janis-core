...
workflow  {
    ...
    ALIGN_AVG_STRUCTS_PAIRWISE(
        CHOP_AND_AVG_FOR_CORE.out.averaged_structs.toList(),
        CHOP_AND_AVG_FOR_CATH2PFAM.out.averaged_structs,
        CHOP_AND_AVG_FOR_PFAM2_CATH.out.averaged_structs
    )
...
ch_contigs = Channel.fromPath( params.contigs )
ch_lsu_db  = Channel.fromPath( params.lsu_db ).toList()
ch_ssu_db  = Channel.fromPath( params.ssu_db ).toList()
...
workflow  {
    ...
    AFTER_QC(
        ...
        params.egg_nog_data_dir,
        params.egg_nog_db,
        params.egg_nog_diamond_db,
        ...
        params.uniref90_db_txt,
        params.cgc_chunk_size,
        params.clusters_glossary,
        params.diamond_database_file,
        params.diamond_header,
        params.diamond_max_target_seqs,
        BEFORE_QC.out.filtered_fasta,
        params.func_ann_names_hmmer,
        params.func_ann_names_ips,
        params.go_config,
        params.gp_flatfiles_path,
        params.graphs,
        ...
        params.pathways_names,
        params.protein_chunk_size_ips,
        params.protein_chunk_size_eggnog,
