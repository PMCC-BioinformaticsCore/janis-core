...
from ... import naming 
from ...model.files.channels import ChannelDefinition
from ...model.files.channels import ChannelDefinitionBlock
...
def create_channel_definitions_block(tool: Tool, tinput_ids: set[str]) -> ChannelDefinitionBlock:
    ...
    return ChannelDefinitionBlock(channels)

def create_channel_definition(tinput) -> ChannelDefinition:
    pass
