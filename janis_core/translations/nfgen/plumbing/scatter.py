...
def handle_scatter_relationship(srcscatter: bool, destscatter: bool, srctype: DataType, desttype: DataType) -> str:
    # secondaries
    if _scatter_secondary_array_to_scatter_secondary(srcscatter, destscatter, srctype, desttype):
    ...
    # non-secondaries
    elif _scatter_to_scatter(srcscatter, destscatter, srctype, desttype):
