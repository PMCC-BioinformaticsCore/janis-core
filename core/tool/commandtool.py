...
from core.tool.tool import Tool, ToolArgument, ToolInput, ToolTypes
from core.utils.metadata import ToolMetadata, Metadata
...
class CommandTool(Tool, ABC):
    ...
    def translate(
        ...
        return core.translations.translate_tool(
            self,
            translation,
